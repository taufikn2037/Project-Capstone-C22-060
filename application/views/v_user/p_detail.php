    ...
    <div class="col mx-auto">
        <div class="col-lg-7">
            <div class="form-group">
                ...
                <textarea name="tanggapan" class="form-control" id="tanggapan" cols="30" rows="11" readonly><?= $data_pengaduan['isi_laporan'] ?></textarea>
            </div>
        </div>
        <div class="col-lg-7">
            <div class="form-group">
                <label for="tanggapan">Tanggapan</label>
                <textarea name="tanggapan" class="form-control" id="tanggapan" cols="30" rows="11" readonly><?= $data_pengaduan['tanggapan']; ?></textarea>
            </div>
        </div>
    </div>
</div>